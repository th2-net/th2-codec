...
abstract class AbstractCodecProcessor(
    ...
    protected val eventProcessor = EventProcessor(onEvent)
    ...
    protected fun Set<String>.onEachEvent(
        ...
        onEachEvent(message, messagesIds, body)
    }
    ...
    protected fun Set<String>.onEachWarning(
        ...
        onEachWarning(context, action, additionalBody, messagesIds)
    }
    ...
    protected fun Set<String>.onEachErrorEvent(
        ...
        onEachErrorEvent(message, messagesIds, cause, additionalBody)
    }
}