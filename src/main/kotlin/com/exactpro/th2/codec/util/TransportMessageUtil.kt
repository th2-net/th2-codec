...
fun MessageGroup.extractPairIds(groupBatch: GroupBatch): Sequence<Pair<ProtoMessageID, ProtoEventID?>> = messages.asSequence()
    .map { it.id.toProto(groupBatch) to it.eventId?.toProto() }
